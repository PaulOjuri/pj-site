  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'rgba(67,59,48,0.45)',
          }}
        />

        {/* Sand gradient scrim at bottom */}
        <div
          style={{
            position: 'absolute',
            bottom: 0,
            ...
            right: 0,
            height: '35%',
            background: 'linear-gradient(to bottom, transparent, var(--lc-sand))',
          }}
        />
      ...
      <section style={{ padding: '2rem 0 6rem' }}>
        ...
        {differenceItems.map((item, index) => (
          <div
            ...
            style={{
              backgroundColor:
                index % 2 === 0 ? 'var(--lc-sand)' : 'var(--lc-sand-deep)',
      ...
      >
        <div style={{ maxWidth: '80rem', margin: '0 auto' }}>
          ...
          <div
            style={{
              ...
              gap: '1px',
              backgroundColor: 'var(--lc-gold-light)',
            }}
          >
        ...
        <style>{`
          .service-card:hover {
            background-color: var(--lc-sand) !important;
          }
        `}</style>
      </section>
      ...
      >
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(to right, rgba(67,59,48,0.75) 0%, rgba(67,59,48,0.2) 60%, transparent 100%)',
            display: 'flex',
            alignItems: 'center',
            padding: '4rem 5vw',
          }}
        >
          <div style={{ maxWidth: '480px' }}>
            <p
              ...
              style={{ color: 'var(--lc-gold-light)', marginBottom: '1rem' }}
            >
              Featured Work
            </p>
            <h2
            ...
            <Link href="/luxciti/portfolio" className="lc-btn" style={{ color: 'var(--lc-ivory)', borderColor: 'var(--lc-gold-light)' }}>
      ...
      <section
        style={{
          padding: 'clamp(5rem, 10vw, 9rem) 2rem',
          textAlign: 'center',
          backgroundColor: 'var(--lc-espresso)',
        }}
      >
        <p
          className="lc-eyebrow"
          style={{ color: 'var(--lc-gold-light)', marginBottom: '1.5rem' }}
        >
        ...
        <Link href="/luxciti/enquire" className="lc-btn" style={{ color: 'var(--lc-ivory)', borderColor: 'var(--lc-gold)' }}>
