              ...
              >
                ...
                >
                  <p
                    ...
                    style={{ color: 'var(--lc-gold-light)', fontSize: '0.6rem' }}
                  >
                    {label}
                  </p>
                </div>
            ...
            {testimonials.map((t) => (
              <article
                ...
                style={{
                  ...
                  gap: '1.25rem',
                  borderTop: '1px solid var(--lc-gold-light)',
                }}
              >
                <p
                  className="lc-serif"
      ...
      >
        <div style={{ maxWidth: '40rem', margin: '0 auto' }}>
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--lc-cream)' }}
          >
            <p
              className="lc-serif"
              style={{ fontSize: '1rem', fontStyle: 'italic', color: 'var(--lc-gold-deep)', marginBottom: '0.75rem' }}
            >
              Honoured with
            </p>
            <h2
