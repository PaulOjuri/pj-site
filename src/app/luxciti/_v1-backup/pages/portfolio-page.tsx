      ...
      >
        <div style={{ maxWidth: '80rem', margin: '0 auto' }}>
          <p
            ...
            style={{ color: 'var(--lc-gold-light)', marginBottom: '0.75rem', textAlign: 'center' }}
          >
            Case Study
          </p>
          <h2
          ...
          >
            <div>
              <p
                className="lc-eyebrow"
                style={{ color: 'var(--lc-gold-light)', marginBottom: '0.75rem' }}
              >
                The Brief
              </p>
              <p
          ...
          <div style={{ marginTop: '4rem' }}>
            <p
              className="lc-eyebrow"
              style={{ color: 'var(--lc-gold-light)', textAlign: 'center', marginBottom: '2rem' }}
            >
              Concept to reality
            </p>
            <div
          ...
          >
            ...
            <div style={{ position: 'absolute', bottom: '1.5rem', left: '1.5rem' }}>
              <p className="lc-eyebrow" style={{ color: 'var(--lc-gold-light)' }}>
          ...
          >
            ...
            >
              <span className="lc-eyebrow" style={{ color: 'var(--lc-mocha)' }}>
                — Adaeze &amp; Emeka Okafor
              </span>
            </footer>
          </blockquote>
