                  ...
                  {i < timelineStages.length - 1 && (
                    <div
                      style={{
                        ...
                        background: 'linear-gradient(to bottom, var(--lc-gold), var(--lc-gold-light))',
                        opacity: 0.4,
                      }}
                    />
                  )}
        ...
        <div style={{ maxWidth: '72rem', margin: '0 auto' }}>
          ...
          >
            {[
              ...
              <div
                ...
                style={{
                  borderTop: '1px solid rgba(179,147,92,0.3)',
                  paddingTop: '2rem',
                }}
              >
                <h3
          ...
          <div style={{ textAlign: 'center', marginTop: '4rem' }}>
            <Link
              ...
              className="lc-btn"
              style={{ color: 'var(--lc-ivory)', borderColor: 'var(--lc-gold)' }}
            >
