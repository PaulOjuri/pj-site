...
export function HubFilter({ posts }: HubFilterProps) {
  ...
  return (
    <div>
        ...
        {tribes.map((tribe) => (
          <button
            ...
            style={{
              ...
              color: activeTribe === tribe ? 'var(--lc-charcoal)' : 'var(--lc-charcoal)',
        ...
        {categories.map((cat) => (
          <button
            ...
            style={{
              ...
              textTransform: 'uppercase',
              color: activeCategory === cat ? 'var(--lc-charcoal)' : 'var(--lc-ink-70)',
              cursor: 'pointer',
              padding: '0.25rem 0',
        ...
        >
          {filtered.map((post, i) => (
            ...
            >
              <article
                style={{
                  backgroundColor: i === 0 ? 'var(--lc-ivory-hi)' : 'var(--lc-ivory)',
                  padding: '2rem',
                  height: '100%',
                  display: 'flex',
      ...
      <style>{`
        .hub-card:hover {
          box-shadow: 0 8px 32px rgba(60,53,48,0.08);
        }
